...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [21] = {.count = 1, .reusable = true}, REDUCE(sym_variable, 1),
  ...
  [39] = {.count = 1, .reusable = true}, REDUCE(sym__term, 1),
  ...
  [53] = {.count = 1, .reusable = true}, REDUCE(sym_binding, 1),
  ...
  [70] = {.count = 1, .reusable = true}, REDUCE(sym_application, 2),
  ...
  [80] = {.count = 1, .reusable = true}, SHIFT(35),
  ...
  [94] = {.count = 1, .reusable = true}, REDUCE(sym_bin_op, 3),
  [96] = {.count = 1, .reusable = false}, REDUCE(sym_boolean, 1),
  [98] = {.count = 1, .reusable = false}, SHIFT_EXTRA(),
  ...
  [108] = {.count = 1, .reusable = false}, SHIFT(33),
  [110] = {.count = 1, .reusable = false}, SHIFT(34),
  [112] = {.count = 1, .reusable = false}, SHIFT(35),
  [114] = {.count = 1, .reusable = false}, SHIFT(45),
  [116] = {.count = 1, .reusable = false}, SHIFT(46),
  [118] = {.count = 1, .reusable = false}, SHIFT(48),
  [120] = {.count = 1, .reusable = true}, SHIFT(47),
